  ...
  return (
    <div className="flex w-full items-center justify-between lg:hidden">
      ...
      <div className="flex items-center gap-3 relative">
        <button className="bg-foodstar-400 text-white py-2 px-3 rounded-full">
          Use App
        </button>
        {reduxState?.user?.fullname ? (
          <>
            ...
            <div
              ...
              className="border p-2 border-gray-300 text-foodstar-400 w-20 h-20 rounded-full"
            >
              <img
          ...
          <>
            <span
              onClick={() => setIsDropDownOpen((prev) => !prev)}
              className="border p-2 border-gray-300 text-foodstar-400 rounded-full"
            >
              <FaUserAlt />
            </span>
            {isDropDownOpen && (
  ...
  const reduxState = useSelector((global) => global.user.user);
    ...
    return (
      <>
        ...
        <div className="hidden lg:inline gap-4 w-full items-center justify-around lg:flex ">
          <div className="w-28">
            <img
              src="https://b.zmtcdn.com/web_assets/b40b97e677bc7b2ca77c58c61db266fe1603954218.png"
              alt="logo"
            ...
            <div className="flex items-center gap-2 border-r-2 border-gray-300 pr-2">
              <span className="text-foodstar-400">
                <HiLocationMarker />
              </span>
              <input
                type="text"
           ...
           {reduxState?.user?.fullname ? (
            <div className="relative w-20">
              ...
              <div
                onClick={() => setIsDropDownOpen((prev) => !prev)}
                className="border p-2 border-gray-300 text-foodstar-400 w-full h-20 rounded-full"
              >
                <img
                  src={gravatar.url(reduxState?.user?.email)}
                  alt={reduxState?.user?.email}
