                  ...
                  <form className="flex flex-col gap-3">
                    <div className=" w-full flex flex-col gap-2">
                      ...
                      <input
                        ...
                        className="w-full border border-gray-400 px-3 py-2 rounded-lg focus:outline-none focus:border-foodstar-400"
                      />
                    </div>
                    <div className=" w-full flex flex-col gap-2">
                    ...
                    <div className="w-full  text-center bg-foodstar-400 text-white py-2 rounded-lg">
                      Sign in
                    </div>
                  </form>
                </div>
