  ...
  return (
    <>
      <div className=" md:hidden flex items-center justify-between">
        ...
        <button className="flex items-center gap-1 bg-foodstar-400 px-3 py-1 text-white rounded-lg">
    ...
    <>
      <div className=" hidden md:flex items-center justify-between container px-20 mx-auto">
        ...
        <h4 className="text-xl">
          ...
          <button className="flex items-center text-lg h-10 font-light gap-1 bg-foodstar-400 px-3 py-1 text-white rounded-lg">
            Continue <IoMdArrowDropright />
          </button>
        </div>
      </div>
